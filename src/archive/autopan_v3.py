...
OUTPUT_PATH = "data/processed/autopan_short_test_v3.mp4"
...
MAX_YAW_DEVIATION   = 30.0
MAX_PITCH_DEVIATION = 12.0

CENTERING_FORCE = 0.03  # gentle pull back toward center every frame
...
while True:
    ...
    d_yaw = YAW_GAIN * (tx_norm - 0.5) * FOV_DEG
    d_pitch = PITCH_GAIN * (ty_norm - 0.5) * FOV_DEG * -1.0

    # Apply limited per-frame motion
