...
def main():
    ...
    teamcfg = TeamClusterConfig(
        ...
        # --- classification gates (make labels actually emit) ---
        min_margin_for_label=0.05,
        max_best_dist_for_label=6.0,
        # --- make tiny players less likely to be rejected ---
        min_non_grass_frac=0.10,
        min_kept_px=10,
        min_roi_px=12*12,
        roi_resize=64,
    )
